                ...
                if (options) {
                    ...
                    var func = function (callback) {
                        ...
                        var loadMultipleCallback = function (err, results) {
                            ...
                            // Fix bug when importing an empty list
                            if (!modelList) return;
...
importer.notification = function (data, callback) {
    var methods = {
    ...
    if (op) {
        ...
        importer[op].call(importer, item.type, item.id, cb);    
        
    } else {
        // If the importer doesnt process the notification, call the callback directly
        callback(data);
    }
