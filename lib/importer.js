...
var importers = {
    ...
    tvshow: {
        ...
        id: 'tvshowid',
        params: {
            properties: ['year', 'rating', 'thumbnail', 'genre', 'studio', 'plot', 'mpaa', 'votes', 'cast', 'premiered', 'fanart']
        }
    },
    ...
    episode: {
        ...
        id: 'episodeid',
        params: {
            properties: ['plot', 'rating', 'episode', 'firstaired', 'playcount', 'thumbnail', 'resume', 'season', 'tvshowid']
        }
    }
};
